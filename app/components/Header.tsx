...
export default function Header() {
  ...
  return (
    <header className="relative w-full min-h-screen overflow-hidden theme-header">
      <div className="absolute inset-0 bg-gradient-to-br from-slate-100/90 via-white/80 to-slate-200/90 dark:from-slate-950/85 dark:via-slate-900/85 dark:to-slate-800/90" />
      <Image
        src="/next.svg"
        alt="background"
        fill
      ...
      <div className="relative z-10 flex min-h-screen flex-col-reverse gap-10 px-6 py-10 lg:flex-row lg:items-center lg:justify-between lg:px-16">
        ...
        <div className="relative z-10 flex w-full justify-center lg:w-auto">
          <Image
            ...
            width={360}
            height={480}
            className="max-w-full rounded-[2rem] object-cover shadow-[0_30px_90px_rgba(15,23,42,0.3)]"
          />
        </div>
      </div>
    </header>
